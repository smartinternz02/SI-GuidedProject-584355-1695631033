    ...
    if request.method=="POST":
       for x in range (1,5):
        ...
        if f.filename != '':
            ...
            COS_API_KEY_ID = "Om8_aLDIjfSAJ4Fytwj67Sae01w4X96IPVbVqTu_63He"
            COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/9fd5b69a47434c97848f8ab387b05d5b:d542bbd2-69a5-4c8e-823a-0a9ed42f1fa5::"
            ...
            cos.meta.client.upload_file(Filename= filepath,Bucket='cookbucket',Key= u+x+".pdf")
...
def marksassign(stdname):
    ...
    output = cos.list_objects(Bucket="cookbucket")
    output
    l=[]
